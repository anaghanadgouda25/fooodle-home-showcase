    ...
    <footer className="bg-card border-t border-border py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Categories */}
          <div>
            <h3 className="font-bold text-lg mb-4 text-card-foreground">Categories</h3>
            <ul className="space-y-2">
              <li className="text-muted-foreground">Fast Food</li>
              <li className="text-muted-foreground">Beverages</li>
              <li className="text-muted-foreground">Desserts</li>
              <li className="text-muted-foreground">Healthy Options</li>
            </ul>
          </div>
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-muted-foreground">
          <p>&copy; 2024 Fooodle. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
